...
export namespace Authorize {
     ...
     */
    export async function sign(localAuthPriv: BN, data: string | number[]| CryptoJSBytes): Promise<string> {
     ...
     * @param sig
     */
     export function verify(authPub: any, data: string | number[]| CryptoJSBytes, sig: string): boolean {
        // Get r,s
